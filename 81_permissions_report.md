...
Pozwala ona na użycie komendy `adb jdwp` do śledzenia procesów aplikacji przez osoby niepowołane. 

### 🛠️ 3. Akcja korygująca
Zaleca się wdrożenie skryptu do procesu CI/CD (np. w Jenkins/GitHub Actions), 
który będzie automatycznie blokował buildy, jeśli `RiskyPermission.xml` wykaże flagę `debuggable="true"`.

####  Raport wykonanay przez:
**Podpis:** Maciej Wilczyński 81514
**Data:**  18.04.2026
